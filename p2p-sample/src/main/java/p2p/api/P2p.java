...
public final class P2p implements AutoCloseable {
    ...
    public String createGroup(String groupId) throws Exception {
        ...
        currentGroup = new P2pSessionInstance(signal, peerId, actualGroupId, downloadDirectory);
        currentGroup.start();
    ...
    public P2pSessionInstance joinGroup(String groupId) throws Exception {
        ...
        currentGroup = new P2pSessionInstance(signal, peerId, actualGroupId, downloadDirectory);
        currentGroup.start(P2pSessionInstance.peersFrom(joined.payload().path("peers")));
        return currentGroup;
    }
